...
const JA: Dict = {
  ...
  externalKeyer: '外部打鍵器', externalKeyerHint: 'USBキーボード型またはシリアル出力の打鍵器を使えます。',
  keyerCapture: 'キー入力を受ける', keyerCaptureHint: 'この枠を選んで打鍵',
  baudRate: 'ボーレート', serialConnect: 'Serial 接続', serialDisconnect: '切断',
  serialStatusidle: '未接続', serialStatusconnected: '接続中', serialStatusunsupported: '非対応', serialStatuserror: '接続エラー',
  learnTitle: '文字を選んで経路を確認', learnHelp: 'プレート上の経路を見ながら、同じ符号を打鍵してください。',
  ...
  treeLegend: '緑: 入力経路 / 青: 目標', start: 'START', candidateNone: '—',
  ...
  modeHelpLearn: '符号の形とプレート上の位置を結び付けます。',
...
const EN: Dict = {
  ...
  externalKeyer: 'External keyer', externalKeyerHint: 'Use a USB keyboard-style keyer or serial-output keyer.',
  keyerCapture: 'Capture key input', keyerCaptureHint: 'Focus this area and key',
  baudRate: 'Baud rate', serialConnect: 'Connect Serial', serialDisconnect: 'Disconnect',
  serialStatusidle: 'Disconnected', serialStatusconnected: 'Connected', serialStatusunsupported: 'Unsupported', serialStatuserror: 'Connection error',
  learnTitle: 'Choose a character and inspect its path', learnHelp: 'Follow the highlighted plate path, then key the same code yourself.',
  ...
  treeLegend: 'Green: input path / Blue: target', start: 'START', candidateNone: '—',
  ...
  modeHelpLearn: 'Connect each code pattern with its position on the plate.',
